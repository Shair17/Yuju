...
interface Props
  extends NativeStackScreenProps<ReferralsStackParams, 'MyReferralsScreen'> {}

export const MyReferralsScreen: React.FC<Props> = ({navigation, route}) => {
  const {isLoading, data: myReferrals} = useRequest<GetReferralsResponse>({
    method: 'GET',
    url: '/referrals/driver',
  });
