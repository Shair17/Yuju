...
import {ReferralsStackParams} from '../stacks/ReferralsStackScreen';
...
interface Props
  extends NativeStackScreenProps<ReferralsStackParams, 'ReferralsScreen'> {}

export const ReferralsScreen: React.FC<Props> = ({navigation, route}) => {
  const {
    isLoading,
    myReferrals,
        ...
        {!isActive ? (
          <Div mt="2xl">
            <Text textAlign="center" fontSize={8} color="gray500">
              Para participar en el programa de referidos tu cuenta debe estar
              activada.
            </Text>
          </Div>
        ) : null}
