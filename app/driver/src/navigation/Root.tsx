...
import {Root as RootAppDrawer} from './drawer/Root';
...
import {AskVehicleDataScreen} from './screens/AskVehicleDataScreen';
        ...
        <RootStack.Group
          ...
          {appIsLoading ? (
            ...
            <RootStack.Group
              ...
              />
              <RootStack.Screen
                name="AskVehicleDataScreen"
                component={AskVehicleDataScreen}
                options={{
                  title: '¡Yuju, ya casi!',
                }}
              />
